...
function ready() {
  ...
  for (let i = 0; i < addToCartButtons.length; i++) {
    let addToCart = addToCartButtons[i];
...
function addToCartClick(event) {
  ...
  let shopItem = addToCart.parentElement.parentElement;
...
function updateCartTotal() {
  ...
  for (let i = 0; i < cartRows.length; i++) {
    ...
    let quantityElement = rows.getElementsByClassName("cart-quantity-input")[0];
